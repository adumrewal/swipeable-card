...
class TinderSwapCard extends StatefulWidget {
  ...
  double _totalMovementHorizontal;
  bool _swipeUp;
  bool _swipeDown;
  ...
  TinderSwapCard(
      ...
      double totalMovementHorizontal = 30.0,
      bool swipeUp = false,
      ...
      : this._cardBuilder = cardBuilder,
        ...
        assert(totalMovementHorizontal > 0),
        this._totalMovementHorizontal = totalMovementHorizontal,
        ...
        child: Transform.rotate(
            ...
            child: new SizedBox.fromSize(
              ...
              child: widget._cardBuilder(
                  ...
                  frontCardAlign.x * 2.0 / widget._totalMovementHorizontal),
            )),
      );
    }
    ...
    return Align(
      ...
      child: new SizedBox.fromSize(
        size: _animationController.status == AnimationStatus.forward &&
            ...
            : _cardSizes[index],
        child:
            widget._cardBuilder(context, widget._totalNum - realIndex - 1, 0),
      ),
    );
  }
          ...
          setState(() {
            if (widget._allowVerticalMovement == true) {
              frontCardAlign = new Alignment(
                  frontCardAlign.x +
                      details.delta.dx *
                          widget._totalMovementHorizontal /
...
typedef Widget CardBuilder(BuildContext context, int index, double currentPos);
